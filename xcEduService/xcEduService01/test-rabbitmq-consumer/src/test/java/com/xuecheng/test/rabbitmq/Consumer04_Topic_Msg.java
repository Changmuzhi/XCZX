...
public class Consumer04_Topic_Msg {
    //队列名称
    private static final String QUEUE_INFORM_SMS = "queue_msg";
    //路由名称
    private static final String TOPICS = "topics";
    //routingkey名称
    private static final String ROUTINGKEY_MSG = "com.xuecheng.test.#.msg.#";
    ...
    public static void main(String[] args) throws IOException, TimeoutException {
        ...
        //绑定交换机
        channel.queueBind(QUEUE_INFORM_SMS,TOPICS,ROUTINGKEY_MSG);
